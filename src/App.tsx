...
function App() {
  ...
  const [guesses, setGuesses] = useState<string[]>(() => {
    ...
    if (loaded.guesses.length === MAX_CHALLENGES && !gameWasWon) {
      trackEvent('Loss', 'Game lost', true)
      setIsGameLost(true)
    }
  ...
  return (
    <div className="pt-2 pb-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <button
        type="button"
        className="mx-auto mt-8 flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 select-none"
