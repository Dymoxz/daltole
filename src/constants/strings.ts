...
export const WORD_NOT_FOUND_MESSAGE = 'Docent niet gevonden'
...
export const TOTAL_TRIES_TEXT = 'Totale pogingen'
export const SUCCESS_RATE_TEXT = 'Winstpercentage'
export const CURRENT_STREAK_TEXT = 'Huidige winreeks'
export const BEST_STREAK_TEXT = 'Beste winreeks'
